...
//void TextureHandler::IsCubeMap(const string &filename, bool cubeMap)
//{
//   // initializeOpenGLFunctions();
...
//        std::string temp = "../GEA2021/Assets/Textures/skybox/" +justName + std::to_string(i+1) +  ".bmp";   //adding Cubemap path and 1 - 6 to filename
//        readBitmap(temp);
//        mCubemap[i] = mBitmap;
//    }
//}
