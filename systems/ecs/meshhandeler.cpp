...
MeshData MeshHandler::makeCircleSphere(float radius, bool rgbColor)
{
    ...
    for (int i{0}; i < 24 ; i++)
    {
        ...
        tempMesh.mVertices.push_back(Vertex{0.f, yNew, zNew,    color.x, color.y, color.z,   0.f, 0.f});
    }
    ...
    for (int i{0}; i < 24 ; i++)
    {
        ...
        tempMesh.mVertices.push_back(Vertex{xNew, 0.f, zNew,      color.x, color.y, color.z,   0.f, 0.f});
    }
    ...
    for (int i{0}; i < 24 ; i++)
    {
        ...
        tempMesh.mVertices.push_back(Vertex{xNew, yNew, 0.f,      color.x, color.y, color.z,   0.f, 0.f});
    }

    //Making indices:
    for (int i{0}; i < 23 ; i++)
    {
        tempMesh.mIndices.push_back(i);
        tempMesh.mIndices.push_back(i+1);
    }
    tempMesh.mIndices.push_back(23);
    tempMesh.mIndices.push_back(0);
    ...
    tempMesh.mIndices.push_back(47);
    tempMesh.mIndices.push_back(24);
    ...
    tempMesh.mIndices.push_back(71);
    tempMesh.mIndices.push_back(48);
...
MeshData MeshHandler::makeLineBox(std::string meshName)
{
    ...
    temp.mVertices.insert( temp.mVertices.end(),
    ...
    //One line at a time
    temp.mIndices.insert( temp.mIndices.end(),
