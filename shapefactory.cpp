...
Square::Square()
{
    ...
    // Positions            // Colors       //UV
    mMesh->mVertices.push_back(Vertex{0,0,0, 1,0,0});  // Bottom Left
    mMesh->mVertices.push_back(Vertex{0.5,0,0, 1,0,0}); // Bottom Right
    mMesh->mVertices.push_back(Vertex{0,0.5,0, 1,0,0});// Top

    mMesh->mVertices.push_back(Vertex{0.5,0,0,  1,0,0});  // Bottom Left
    mMesh->mVertices.push_back(Vertex{0.5,0.5,0,  1,0,0}); // Bottom Right
    mMesh->mVertices.push_back(Vertex{0,0.5,0,  1,0,0});  // Top
