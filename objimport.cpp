...
//{
//    glBindVertexArray( MeshComp->mVAO );
//    glDrawElements(GL_TRIANGLES, MeshComp->mIndices.size(), GL_UNSIGNED_INT, nullptr);
//    glBindVertexArray(0);
//}
...
void ObjImport::readFile(std::string filename, std::vector<Vertex> *mVertices, std::vector<GLuint> *mIndices)
{
    //Open File
       //    std::string filename = Orf::assetFilePath.toStdString() + fileName + ".obj";
