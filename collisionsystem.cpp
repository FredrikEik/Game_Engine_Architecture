...
//bool CollisionSystem::CheckMousePickCollisions(int i,gsl::Vector3D ray_wor,Camera *mCurrentCamera,VisualObject *mVisualObjects, CollisionComponent *sCollision)
//{
