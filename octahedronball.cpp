...
OctahedronBall::OctahedronBall(int n) : mRecursions(n)
{
    getMeshComponent()->mVertices.reserve(3 * 8 * pow(4, mRecursions));
    octahedronUnitBall();
}
...
void OctahedronBall::makeTriangle(const Vec3& v1, const Vec3& v2, const Vec3& v3)
{
   Vertex v{};
